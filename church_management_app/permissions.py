...
ROLE_PERMISSIONS = {
    'super_admin': {
        'menu': ['dashboard', 'members', 'events', 'attendance', 'finances', 'announcements', 
                 'trainings', 'logistics', 'diaconat', 'evangelisation', 'marriages', 
                 'reports', 'account'],
        'can_create': True,
        'can_edit': True,
        'can_delete': True,
    ...
    'protocol_head': {
        'menu': ['dashboard', 'members', 'events', 'attendance', 'announcements', 'account'],
        'can_create': True,
        'can_edit': True,
        'can_delete': False,
        'can_export': True,
    ...
    'secretary': {
        'menu': ['dashboard', 'members', 'events', 'attendance', 'announcements', 
                 'marriages', 'reports', 'account'],
        'can_create': True,
        'can_edit': True,
        'can_delete': False,
        'can_export': True,
    ...
    'department_head': {
        'menu': ['dashboard', 'members', 'events', 'attendance', 'account'],
        'can_create': True,
        'can_edit': True,
        'can_delete': False,
        'can_export': False,
